class Show < ActiveRecord::Base
  ...
  def self.highest_rating
    #this method should return the highest value in the ratings column. hint: if
    #there is a minimum Active Record method, might there be a maximum method?
    Show.maximum(:rating)
  end
  ...
  def self.shows_by_alphabetical_order
    #returns an array of all of the shows sorted by alphabetical order according
